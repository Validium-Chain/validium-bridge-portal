...
.modal-container {
  ...
  .modal-card-container {
    ...
    .modal-card {
      @apply relative max-h-[600px] w-full max-w-[600px] transform overflow-hidden rounded-3xl rounded-b-none bg-neutral-50 p-block-padding-1/2 text-left shadow-xl transition-all dark:bg-[#1F143C] sm:rounded-b-3xl sm:p-block-padding;
