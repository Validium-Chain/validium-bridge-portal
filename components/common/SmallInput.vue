...
.small-input-container {
  @apply flex h-12 w-full items-center rounded-3xl bg-gray-input px-4 py-3 transition-colors dark:bg-[#1F143C];
  &.focused,
  &:hover {
    @apply bg-gray-input-focus dark:bg-[#1F143C];

    .small-input-clear-button {
      @apply bg-gray-400 dark:bg-[#39246c];
    }
  }
  ...
  .small-input-clear-button {
    @apply block aspect-square h-6 w-6 self-end rounded-full bg-gray-300 p-1 transition-all dark:bg-[#1F143C];
    &:hover {
      @apply bg-gray-500 dark:bg-[#3e2874];
    }
