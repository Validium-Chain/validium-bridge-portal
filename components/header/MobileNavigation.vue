...
.mobile-navigation-container {
  @apply fixed left-0 top-0 z-[60] w-full overflow-y-auto overflow-x-hidden bg-neutral-50 dark:bg-[#180F2D];
  height: 100vh;
  height: 100dvh;

  .navigation-header {
    @apply sticky top-0 flex items-center justify-between bg-neutral-50/70 p-2 backdrop-blur dark:bg-[#180F2D]/70 sm:p-4;
